...
public class CreateMetaDataRequestV1 implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -3155680782273961138L;
    ...
    public String toString() {
        return "CreateMetaDataRequestV1 [documentName=" + documentName
                + ", documentType="
                + documentType
                + ", comment="
                + comment
